...
package odoo_v17_data_migration.onboardingdemojob_0_1;
...
public class OnBoardingDemoJob implements TalendJob {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_ODOO_V17_DATA_MIGRATION_OnBoardingDemoJob = new byte[0];
		static byte[] commonByteArray_ODOO_V17_DATA_MIGRATION_OnBoardingDemoJob = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ODOO_V17_DATA_MIGRATION_OnBoardingDemoJob.length) {
					if (length < 1024 && commonByteArray_ODOO_V17_DATA_MIGRATION_OnBoardingDemoJob.length == 0) {
						commonByteArray_ODOO_V17_DATA_MIGRATION_OnBoardingDemoJob = new byte[1024];
					} else {
						commonByteArray_ODOO_V17_DATA_MIGRATION_OnBoardingDemoJob = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ODOO_V17_DATA_MIGRATION_OnBoardingDemoJob, 0, length);
				strReturn = new String(commonByteArray_ODOO_V17_DATA_MIGRATION_OnBoardingDemoJob, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_ODOO_V17_DATA_MIGRATION_OnBoardingDemoJob, 0, length);
				strReturn = new String(commonByteArray_ODOO_V17_DATA_MIGRATION_OnBoardingDemoJob, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ODOO_V17_DATA_MIGRATION_OnBoardingDemoJob) {
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2025-01-08T09:12:14.470464Z");
		...
		try {
			...
			java.io.InputStream inContext = OnBoardingDemoJob.class.getClassLoader().getResourceAsStream(
					"odoo_v17_data_migration/onboardingdemojob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 60451 characters generated by Talend Cloud Data Management Platform on the 8
 * January 2025 at 1:12:14 PM GST
 ************************************************************************************************/